...
<div id="user-nav" class="navbar navbar-inverse">
	<ul class="nav">
		<li  class="dropdown" id="profile-messages" ><a title="" href="form.php" data-toggle="dropdown" data-target="form.phpprofile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome Super Admin</span><b class="caret"></b></a>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							require "db.php";
							$db = new db;
							$getManuproducts = $db->getManuproducts();
							...
							<tr class="">
								...
								<td><?php echo $value['manu_name'] ?></td>
									<td><img src='public\images\manufactures\<?php echo $value['manu_img'] ?>'style="width:100px"> </td>
								<td>
									<a href="del.php?manuid=<?php echo $value['manu_ID'] ?>" class="btn btn-danger btn-mini">Delete</a>
								</td>
							</tr>
							<?php } ?>
